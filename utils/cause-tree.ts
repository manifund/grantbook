...
export const CAUSE_TREE: CauseNode[] = [
  ...
  { slug: 'technical-ai-safety', name: 'Technical safety research', parent: 'ai-safety' },
  ...
  { slug: 'ai-control', name: 'Control & monitoring', parent: 'technical-ai-safety' },
  { slug: 'evals', name: 'Evals & auditing', parent: 'technical-ai-safety' },
  { slug: 'robustness-security', name: 'Robustness & security', parent: 'technical-ai-safety' },
  { slug: 'ai-theory', name: 'Theory & foundations', parent: 'technical-ai-safety' },
  { slug: 'ai-policy', name: 'Governance, policy & advocacy', parent: 'ai-safety' },
  ...
  { slug: 'ai-advocacy', name: 'Advocacy & communications', parent: 'ai-policy' },
  { slug: 'ai-fieldbuilding', name: 'Field-building & talent', parent: 'ai-safety' },
  { slug: 'training-pipelines', name: 'Training pipelines', parent: 'ai-fieldbuilding' },
  { slug: 'university-groups', name: 'University groups & courses', parent: 'ai-fieldbuilding' },
  ...
  { slug: 'ai-ecosystem', name: 'Ecosystem & meta', parent: 'ai-safety' },
  ...
  { slug: 'ai-adjacent', name: 'Adjacent', parent: 'ai-safety' },
  { slug: 'ai-bio', name: 'AI × bio', parent: 'ai-adjacent' },
  { slug: 'ai-cyber', name: 'AI × cyber', parent: 'ai-adjacent' },
  { slug: 'digital-minds', name: 'Digital minds & AI welfare', parent: 'ai-adjacent' },
  { slug: 's-risk', name: 'S-risk', parent: 'ai-adjacent' },
  { slug: 'gradual-disempowerment', name: 'Disempowerment & economics', parent: 'ai-adjacent' },
